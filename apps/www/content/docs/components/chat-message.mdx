...
The `Chat` component uses the `CopyButton` and `MarkdownRenderer` components. Make sure you have them installed in your project, following the installation instructions in the respective docs page for each component.
